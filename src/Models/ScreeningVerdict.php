...
class ScreeningVerdict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'account' => '\Developerayo\FireblocksLaravel\Models\Destination',
        'assetId' => 'string',
        'amount' => 'string',
        'matchedRule' => '\Developerayo\FireblocksLaravel\Models\ScreeningVerdictMatchedRule'
    ];
    ...
    protected static $setters = [
        'verdict' => 'setVerdict',
        'executionOperationId' => 'setExecutionOperationId',
        'account' => 'setAccount',
        'assetId' => 'setAssetId',
        'amount' => 'setAmount',
        'matchedRule' => 'setMatchedRule'
    ];
    ...
    protected static $getters = [
        'verdict' => 'getVerdict',
        'executionOperationId' => 'getExecutionOperationId',
        'account' => 'getAccount',
        'assetId' => 'getAssetId',
        'amount' => 'getAmount',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('executionOperationId', $data ?? [], null);
        $this->setIfExists('account', $data ?? [], null);
        $this->setIfExists('assetId', $data ?? [], null);
        $this->setIfExists('amount', $data ?? [], null);
        $this->setIfExists('matchedRule', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['executionOperationId'] === null) {
            $invalidProperties[] = "'executionOperationId' can't be null";
        }
    ...
    /**
     * Gets executionOperationId
     *
     * @return string
     */
    public function getExecutionOperationId()
    {
        return $this->container['executionOperationId'];
    }

    /**
     * Sets executionOperationId
     *
     * @param string $executionOperationId executionOperationId
     *
     * @return self
     */
    public function setExecutionOperationId($executionOperationId)
    {
        if (is_null($executionOperationId)) {
            throw new \InvalidArgumentException('non-nullable executionOperationId cannot be null');
        }
        $this->container['executionOperationId'] = $executionOperationId;
     ...
     * Gets account
     *
     * @return \Developerayo\FireblocksLaravel\Models\Destination
     */
     ...
     * Sets account
     *
     * @param \Developerayo\FireblocksLaravel\Models\Destination $account account
     *
     * @return self
     */
     ...
     * Gets matchedRule
     *
     * @return \Developerayo\FireblocksLaravel\Models\ScreeningVerdictMatchedRule|null
     */
    public function getMatchedRule()
    {
        return $this->container['matchedRule'];
    }

    /**
     * Sets matchedRule
     *
     * @param \Developerayo\FireblocksLaravel\Models\ScreeningVerdictMatchedRule|null $matchedRule matchedRule
     *
     * @return self
     */
    public function setMatchedRule($matchedRule)
    {
        if (is_null($matchedRule)) {
            throw new \InvalidArgumentException('non-nullable matchedRule cannot be null');
        }
        $this->container['matchedRule'] = $matchedRule;
