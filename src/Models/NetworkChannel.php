...
/**
 * NetworkChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class NetworkChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkChannel';
    ...
    {
        $this->setIfExists('networkId', $data ?? [], null);
    ...
    */
    ...
    public function setNetworkId($networkId)
    {
        if (is_null($networkId)) {
            throw new \InvalidArgumentException('non-nullable networkId cannot be null');
        }
