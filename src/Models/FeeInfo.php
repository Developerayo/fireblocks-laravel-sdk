...
class FeeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets networkFee
     *
     * @param string|null $networkFee The fee paid to the network
     *
     * @return self
     */
     ...
     * Sets serviceFee
     *
     * @param string|null $serviceFee The total fee deducted by the exchange from the actual requested amount (serviceFee = amount - netAmount)
     *
     * @return self
     */
