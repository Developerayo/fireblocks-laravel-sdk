...
class TransactionResponseDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'destination_address_description' => true,
        'amount' => false,
        'amount_usd' => false,
        'aml_screening_result' => false,
        'customer_ref_id' => true,
    ...
    */
     ...
     *
     * @param mixed|null $destination_address Address where the asset was transferred.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $destination_address_description Description of the address.
     *
     * @return self
     */
    public function setDestinationAddressDescription($destination_address_description)
    {
        if (is_null($destination_address_description)) {
            array_push($this->openAPINullablesSetToNull, 'destination_address_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('destination_address_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets amount_usd
     *
     * @param string|null $amount_usd The USD value of the requested amount.
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $customer_ref_id The ID for AML providers to associate the owner of funds with transactions.
     *
     * @return self
     */
    public function setCustomerRefId($customer_ref_id)
    {
        if (is_null($customer_ref_id)) {
            array_push($this->openAPINullablesSetToNull, 'customer_ref_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_ref_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
