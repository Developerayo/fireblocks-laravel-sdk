...
/**
 * TokenOwnershipStatusUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class TokenOwnershipStatusUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenOwnershipStatusUpdatePayload';
    ...
    */
     ...
     * Sets asset_id
     *
     * @param string $asset_id Token's asset id
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Token's ownership new status
     *
     * @return self
     */
