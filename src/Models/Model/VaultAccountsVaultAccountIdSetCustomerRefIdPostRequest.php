...
/**
 * VaultAccountsVaultAccountIdSetCustomerRefIdPostRequest Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class VaultAccountsVaultAccountIdSetCustomerRefIdPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_vault_accounts__vaultAccountId__set_customer_ref_id_post_request';
    ...
    */
     ...
     *
     * @param string|null $customer_ref_id Customer reference ID
     *
     * @return self
     */
