...
/**
 * InternalWalletsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class InternalWalletsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_internal_wallets_post_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name the wallet's display name
     *
     * @return self
     */
