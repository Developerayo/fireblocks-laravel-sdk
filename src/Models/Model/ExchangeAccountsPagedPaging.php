...
/**
 * ExchangeAccountsPagedPaging Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class ExchangeAccountsPagedPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExchangeAccountsPaged_paging';
    ...
    */
     ...
     * Sets after
     *
     * @param string|null $after Query value to the after page
     *
     * @return self
     */
     ...
     * Sets before
     *
     * @param string|null $before Query value to the before page
     *
     * @return self
     */
