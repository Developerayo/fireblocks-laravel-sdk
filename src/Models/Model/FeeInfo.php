 ...
 */
class FeeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeInfo';
    ...
    */
     ...
     * Sets network_fee
     *
     * @param string|null $network_fee The fee paid to the network
     *
     * @return self
     */
     ...
     * Sets service_fee
     *
     * @param string|null $service_fee The total fee deducted by the exchange from the actual requested amount (serviceFee = amount - netAmount)
     *
     * @return self
     */
