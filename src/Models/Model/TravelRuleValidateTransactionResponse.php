...
class TravelRuleValidateTransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'is_valid' => false,
        'type' => false,
        'beneficiary_address_type' => false,
    ...
    protected static $attributeMap = [
        'is_valid' => 'isValid',
        'type' => 'type',
        'beneficiary_address_type' => 'beneficiaryAddressType',
    ...
    protected static $setters = [
        'is_valid' => 'setIsValid',
        'type' => 'setType',
        'beneficiary_address_type' => 'setBeneficiaryAddressType',
    ...
    protected static $getters = [
        'is_valid' => 'getIsValid',
        'type' => 'getType',
        'beneficiary_address_type' => 'getBeneficiaryAddressType',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('beneficiary_address_type', $data ?? [], null);
        $this->setIfExists('address_source', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['beneficiary_address_type'] === null) {
            $invalidProperties[] = "'beneficiary_address_type' can't be null";
        }
        if ($this->container['address_source'] === null) {
            $invalidProperties[] = "'address_source' can't be null";
        }
     ...
     * Sets is_valid
     *
     * @param bool $is_valid \"isValid\" will tell you if you have collected all the information needed for the travel rule data transfer. Once this field = \"true\", you can move on to the next step which is to transfer the front-end information to your back-end and perform Travel Rule Transaction create
     *
     * @return self
     */
    ...
    /**
     * Gets beneficiary_address_type
     *
     * @return string
     */
    public function getBeneficiaryAddressType()
    {
        return $this->container['beneficiary_address_type'];
    }

    /**
     * Sets beneficiary_address_type
     *
     * @param string $beneficiary_address_type \"beneficiaryAddressType\" will tell you if your blockchain analytics provider or internal address book has been able to identify the wallet address.
     *
     * @return self
     */
    public function setBeneficiaryAddressType($beneficiary_address_type)
    {
        if (is_null($beneficiary_address_type)) {
            throw new \InvalidArgumentException('non-nullable beneficiary_address_type cannot be null');
        }
        $this->container['beneficiary_address_type'] = $beneficiary_address_type;
     ...
     * Sets address_source
     *
     * @param string $address_source \"addressSource\" will tell you if the address was found in your internal address book or identified by the blockchain analytics provider.
     *
     * @return self
     */
    public function setAddressSource($address_source)
    {
        if (is_null($address_source)) {
            throw new \InvalidArgumentException('non-nullable address_source cannot be null');
        }
     ...
     *
     * @param string $beneficiary_vas_pdid The VASP DID of the beneficiary VASP
     *
     * @return self
     */
     ...
     *
     * @param string $beneficiary_vas_pname \"beneficiaryVASPname\" will tell you the name of the VASP that has been identified as the owner of the wallet address. This name is used in a subsequent call to get its DID.
     *
     * @return self
     */
