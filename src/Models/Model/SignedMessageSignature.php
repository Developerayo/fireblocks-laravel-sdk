...
/**
 * SignedMessageSignature Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class SignedMessageSignature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignedMessage_signature';
    ...
    {
        $this->setIfExists('full_sig', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getFullSig()
    {
        return $this->container['full_sig'];
    }

    /**
     * Sets full_sig
     *
     * @param string|null $full_sig full_sig
     *
     * @return self
     */
    public function setFullSig($full_sig)
    {
        if (is_null($full_sig)) {
            throw new \InvalidArgumentException('non-nullable full_sig cannot be null');
        }
        $this->container['full_sig'] = $full_sig;
