...
/**
 * CreateVaultAccountAssetAddressRequest Class Doc Comment
 *
 * @category Class
 * @package  DeveloperayoFireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class CreateVaultAccountAssetAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createVaultAccountAssetAddress_request';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description (Optional) Attach a description to the new address
     *
     * @return self
     */
