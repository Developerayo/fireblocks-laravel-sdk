...
class SignedMessageSignature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('fullSig', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['fullSig'];
    }

    /**
     * Sets fullSig
     *
     * @param string|null $fullSig fullSig
     *
     * @return self
     */
    public function setFullSig($fullSig)
    {
        if (is_null($fullSig)) {
            throw new \InvalidArgumentException('non-nullable fullSig cannot be null');
        }
        $this->container['fullSig'] = $fullSig;
