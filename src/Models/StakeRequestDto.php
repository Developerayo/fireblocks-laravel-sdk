...
class StakeRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('stakeAmount', $data ?? [], null);
        $this->setIfExists('txNote', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stakeAmount'] === null) {
            $invalidProperties[] = "'stakeAmount' can't be null";
        }
    ...
    {
        return $this->container['stakeAmount'];
    }

    /**
     * Sets stakeAmount
     *
     * @param string $stakeAmount Amount of tokens to stake
     *
     * @return self
     */
    public function setStakeAmount($stakeAmount)
    {
        if (is_null($stakeAmount)) {
            throw new \InvalidArgumentException('non-nullable stakeAmount cannot be null');
        }
        $this->container['stakeAmount'] = $stakeAmount;
    ...
    {
        return $this->container['txNote'];
    }

    /**
     * Sets txNote
     *
     * @param string|null $txNote The note to associate with the stake transactions.
     *
     * @return self
     */
    public function setTxNote($txNote)
    {
        if (is_null($txNote)) {
            throw new \InvalidArgumentException('non-nullable txNote cannot be null');
        }
        $this->container['txNote'] = $txNote;
     ...
     * Sets feeLevel
     *
     * @param string|null $feeLevel Represents the fee level for a transaction, which can be set as slow, medium, or fast. Only one of fee/feeLevel is required.
     *
     * @return self
     */
