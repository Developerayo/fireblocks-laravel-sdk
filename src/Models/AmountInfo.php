 ...
 */
class AmountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AmountInfo';
    ...
    */
     ...
     * Sets amount
     *
     * @param string|null $amount If the transfer is a withdrawal from an exchange, the actual amount that was requested to be transferred. Otherwise, the requested amount.
     *
     * @return self
     */
     ...
     *
     * @param string|null $requestedAmount The amount requested by the user.
     *
     * @return self
     */
