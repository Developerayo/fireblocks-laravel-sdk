...
/**
 * ResendWebhooksResponse Class Doc Comment
 *
 * @category Class
 * @package  Developerayo\FireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class ResendWebhooksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResendWebhooksResponse';
    ...
    {
        $this->setIfExists('messagesCount', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets messagesCount
     *
     * @param float|null $messagesCount messagesCount
     *
     * @return self
     */
    public function setMessagesCount($messagesCount)
    {
        if (is_null($messagesCount)) {
            throw new \InvalidArgumentException('non-nullable messagesCount cannot be null');
        }
