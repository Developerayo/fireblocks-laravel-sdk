...
/**
 * XBSettlementCreateFlowRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Developerayo\FireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class XBSettlementCreateFlowRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XBSettlementCreateFlowRequestBody';
    ...
    */
     ...
     * Sets amount
     *
     * @param string $amount The amount to transfer in this cross-border flow. The type of asset is defined by the cross-border settlement configuration.
     *
     * @return self
     */
