...
class CreateNcwConnectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ncwId'] === null) {
            $invalidProperties[] = "'ncwId' can't be null";
        }
        if ($this->container['ncwAccountId'] === null) {
            $invalidProperties[] = "'ncwAccountId' can't be null";
        }
     ...
     * Sets ncwId
     *
     * @param string $ncwId The ID of the Non-Custodial Wallet to connect to the dApp.
     *
     * @return self
     */
     ...
     * Sets ncwAccountId
     *
     * @param float $ncwAccountId The NCW account ID to connect to the dApp.
     *
     * @return self
     */
