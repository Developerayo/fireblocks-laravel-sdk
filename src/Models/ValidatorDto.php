...
class ValidatorDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('feePercent', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['feePercent'] === null) {
            $invalidProperties[] = "'feePercent' can't be null";
        }
     ...
     *
     * @param string $chainDescriptor The protocol identifier (e.g. \"ETH\"/\"SOL\") of the validator
     *
     * @return self
     */
    ...
    {
        return $this->container['feePercent'];
    }

    /**
     * Sets feePercent
     *
     * @param float $feePercent The service fee as a percentage out of the earned rewards
     *
     * @return self
     */
    public function setFeePercent($feePercent)
    {
        if (is_null($feePercent)) {
            throw new \InvalidArgumentException('non-nullable feePercent cannot be null');
        }
        $this->container['feePercent'] = $feePercent;
