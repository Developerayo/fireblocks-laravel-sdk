...
class PolicyRuleOperators implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('usersGroups', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['usersGroups'];
    }

    /**
     * Sets usersGroups
     *
     * @param string[]|null $usersGroups Set of group ids
     *
     * @return self
     */
    public function setUsersGroups($usersGroups)
    {
        if (is_null($usersGroups)) {
            throw new \InvalidArgumentException('non-nullable usersGroups cannot be null');
        }
        $this->container['usersGroups'] = $usersGroups;
