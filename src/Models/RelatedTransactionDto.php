...
/**
 * RelatedTransactionDto Class Doc Comment
 *
 * @category Class
 * @package  Developerayo\FireblocksLaravel
 * @author   OpenAPI Generator team
 ...
 */
class RelatedTransactionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelatedTransactionDto';
    ...
    */
     ...
     * Sets completed
     *
     * @param bool $completed Is the transaction completed or not
     *
     * @return self
     */
