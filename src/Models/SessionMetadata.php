...
class SessionMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('appDescription', $data ?? [], null);
        $this->setIfExists('appIcon', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['appDescription'];
    }

    /**
     * Sets appDescription
     *
     * @param string|null $appDescription appDescription
     *
     * @return self
     */
    public function setAppDescription($appDescription)
    {
        if (is_null($appDescription)) {
            throw new \InvalidArgumentException('non-nullable appDescription cannot be null');
        }
        $this->container['appDescription'] = $appDescription;
     ...
     * Sets appIcon
     *
     * @param string|null $appIcon appIcon
     *
     * @return self
     */
    ...
    {
        if (is_null($appIcon)) {
            throw new \InvalidArgumentException('non-nullable appIcon cannot be null');
        }
