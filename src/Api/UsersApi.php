...
class UsersApi
{
     ...
     * @return \Developerayo\FireblocksLaravel\Models\GetUsersResponse|\Developerayo\FireblocksLaravel\Models\Error
     */
     ...
     * @throws \Developerayo\FireblocksLaravel\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Developerayo\FireblocksLaravel\Models\GetUsersResponse|\Developerayo\FireblocksLaravel\Models\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Developerayo\FireblocksLaravel\Models\GetUsersResponse',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\Developerayo\FireblocksLaravel\Models\GetUsersResponse';
        $request = $this->usersGetRequest($contentType);
